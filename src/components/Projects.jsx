const PROJECTS = [
  {
    ...
    result: 'Publicada y en uso real, accesible desde el celular.',
  ...
  },
  {
    ...
    badge: { text: 'Demo online', className: 'badge-purple' },
    description:
    ...
    result: 'Implementé autenticación (JWT) y paneles diferenciados por rol.',
  ...
  },
  {
    ...
    result: 'API propia en ASP.NET conectada a una base SQL.',
  ...
  },
  {
    ...
    result: 'Flujo completo: cliente, cocina y administrador con seguimiento por estado.',
